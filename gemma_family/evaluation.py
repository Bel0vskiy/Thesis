...
* **average** (``evaluate_faithfulness_average``): a single mask derived
  from the mean saliency across all tokens — one forward pass per mask
  ratio.  Fast approximation for quick iterations.
